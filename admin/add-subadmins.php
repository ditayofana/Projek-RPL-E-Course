...
<html lang="en">
    <head>
        ...
        <title> E-Course | Add Customer</title>
...
<form class="form-horizontal" name="addsuadmin" method="post">
       ...
       <label for="exampleInputusername">Username </label>
               <input type="text" placeholder="inputkan  Username"  name="sadminusername" id="sadminusername" class="form-control" pattern="^[a-zA-Z][a-zA-Z0-9-_.]{5,12}$" title="Username must be alphanumeric 6 to 12 chars" onBlur="checkAvailability()"  required>
	        ...
	        <label for="emailid">Email Id</label>
	         <input type="email" class="form-control" id="emailid" name="emailid" placeholder="inputkan email" required>
	          </div>
