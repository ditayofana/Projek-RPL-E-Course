...
<html lang="en">
    <head>
        ...
        <title>Newsportal | Edit Sub Material</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Add Sub-Material</h4>
...
<?php } ?>
    ...
    <div class="form-group">
                                                    <label class="col-md-2 control-label">Sub-Material</label>
                                                    <div class="col-md-10">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Sub-Material Description</label>
	                                                <div class="col-md-10">
